package com.huabao.mytest.worldmap.map;
...
import com.huabao.mytest.worldmap.io.RandomAccessFileInputStream;
...
public class ImageViewerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_worldmap);
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(KEY_X) && savedInstanceState.containsKey(KEY_Y)) {
            ...
            try {
                if (fn == null || fn.length()==0) {
                    imageSurfaceView.setInputStream(getAssets().open("test.jpg"));
                } else {
